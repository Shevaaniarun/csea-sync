...
export default function AboutUs() {
  return (
<section className="flex flex-col items-center justify-center pt-0 pb-16 px-6">
    
       <motion.h2
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="cursor-target text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 mb-10"
      >
        About Us
      </motion.h2>
      ...
      >
        ...
        <motion.div
          ...
          className="flex items-start gap-4 text-left bg-black/20 p-5 rounded-xl border border-white/10 hover:border-cyan-400 transition-all duration-300"
        >
          <div className="flex-shrink-0 text-cyan-400">
            <Calendar size={40} />
          </div>
          <div>
            <h3 className="text-2xl font-bold text-white">15+ Events</h3>
